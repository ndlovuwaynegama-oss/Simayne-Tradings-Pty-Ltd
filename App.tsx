...
const App: React.FC = () => {
  ...
  const faqs = [
    ...
    { 
      ...
      answer: "Yes, we specialize in custom branding using our 8-in-1 Heat Press and Silhouette Cameo 4. We can do engraved glassware, merchandise printing, vinyl decals, caps, and more." 
    },
    { 
  ...
  const catalogueData = {
    ...
    "Branding": [
      ...
      { name: "Branded T-Shirts", img: "👕", desc: "Vinyl cut or heat press corporate apparel." },
      { name: "Custom Caps", img: "🧢", desc: "Heat press caps with your company logo." },
    ],
    "Beverages": [
  ...
  return (
    <div className="min-h-screen flex flex-col bg-slate-950 text-slate-100 selection:bg-indigo-500/30 font-sans">
      ...
      <nav className="fixed top-0 w-full z-40 bg-slate-950/70 backdrop-blur-xl border-b border-white/5">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-20">
            <button onClick={() => navigateTo('home')} className="flex items-center gap-3 group cursor-pointer focus:outline-none">
      ...
      <main className="flex-grow pt-20">
        ...
        {activeSection === 'home' && (
          <div className="animate-fade-in">
            {/* Hero Section */}
            <div className="relative pt-20 pb-20 sm:pt-32 sm:pb-24 overflow-hidden z-10">
              <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
                <div className="inline-flex items-center rounded-full border border-blue-500/20 bg-blue-500/10 px-4 py-1.5 text-sm font-medium text-blue-300 mb-8 backdrop-blur-md shadow-lg shadow-blue-900/20">
                ...
                <h1 className="text-5xl md:text-7xl font-bold tracking-tight mb-8 leading-tight min-h-[1.2em]">
                ...
                <p className="mt-6 max-w-2xl mx-auto text-lg md:text-xl text-slate-400 mb-12 leading-relaxed">
                  Your reliable partner in multi-service procurement, supply, and custom production. 
                  Equipped with professional in-house technology to brand, cut, and print exactly what you need.
                </p>
                ...
                <div className="flex flex-col sm:flex-row justify-center gap-5">
                  ...
                  <button onClick={() => navigateTo('catalogue')} className="px-8 py-4 bg-slate-900/50 text-white border border-slate-700 hover:border-blue-500/50 rounded-full font-bold hover:bg-slate-800 transition-all hover:scale-105 backdrop-blur-md">
                    View Catalogue
                  </button>
                </div>
            ...
            <section className="py-12 border-t border-white/5">
              <div className="max-w-7xl mx-auto px-4 text-center">
                  <h4 className="text-slate-500 text-sm font-bold uppercase tracking-widest mb-8">Trusted Partners</h4>
        ...
        {activeSection === 'catalogue' && (
          <div className="animate-fade-in">
            {/* Product Catalogue */}
            <section className="py-16 relative bg-slate-900/50 min-h-screen">
              <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div className="text-center mb-16">
                    <h2 className="text-3xl md:text-4xl font-bold text-white mb-4">Product Catalogue</h2>
                    <p className="text-slate-400 max-w-2xl mx-auto">Browse our most popular categories. Don't see what you need? Use the Request Form below.</p>
                </div>
                ...
                <div className="glass-panel rounded-[2.5rem] p-8 md:p-16 border border-blue-500/20 shadow-2xl shadow-blue-900/20 bg-gradient-to-br from-slate-900 to-slate-950 max-w-4xl mx-auto">
        ...
        {activeSection === 'services' && (
          <div className="animate-fade-in">
             <section className="py-16">
                  ...
                  {/* Highlight: In-House Production Equipment */}
                  {activeCategory === "All" && (
                    <div className="mb-16">
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        {/* 8-in-1 Muggit */}
                        <div className="glass-panel p-8 rounded-3xl border border-blue-500/20 bg-gradient-to-br from-slate-900 to-blue-900/10">
                           <div className="flex items-center gap-4 mb-4">
                              <div className="w-12 h-12 bg-blue-600 rounded-2xl flex items-center justify-center text-white font-bold shadow-lg shadow-blue-500/30">
                                8-1
                              </div>
                              <div>
                                <h4 className="text-lg font-bold text-white">8-in-1 Heat Press Machine</h4>
                                <p className="text-xs text-blue-300 font-medium">Sublimation & Heat Transfer</p>
                              </div>
                           </div>
                           <p className="text-slate-400 text-sm mb-4">Our versatile heat press allows us to print directly onto a wide variety of rigid and fabric surfaces.</p>
                           <div className="flex flex-wrap gap-2">
                              {['Custom Mugs', 'Plates', 'Caps', 'Tiles', 'Coasters', 'Mousepads', 'T-Shirts'].map(item => (
                                <span key={item} className="px-3 py-1 bg-slate-800 rounded-full text-xs text-slate-300 border border-slate-700">{item}</span>
                              ))}
                           </div>
                        </div>

                        {/* Silhouette Cameo 4 */}
                        <div className="glass-panel p-8 rounded-3xl border border-indigo-500/20 bg-gradient-to-br from-slate-900 to-indigo-900/10">
                           <div className="flex items-center gap-4 mb-4">
                              <div className="w-12 h-12 bg-indigo-600 rounded-2xl flex items-center justify-center text-white font-bold shadow-lg shadow-indigo-500/30">
                                SC4
                              </div>
                              <div>
                                <h4 className="text-lg font-bold text-white">Silhouette Cameo 4</h4>
                                <p className="text-xs text-indigo-300 font-medium">Precision Vinyl Cutting</p>
                              </div>
                           </div>
                           <p className="text-slate-400 text-sm mb-4">High-precision cutting for custom graphics, decals, and apparel branding.</p>
                           <div className="flex flex-wrap gap-2">
                              {['Vinyl Stickers', 'Car Decals', 'Wall Art', 'Heat Transfer Vinyl (Apparel)', 'Cardstock Packaging', 'Stencils'].map(item => (
                                <span key={item} className="px-3 py-1 bg-slate-800 rounded-full text-xs text-slate-300 border border-slate-700">{item}</span>
                              ))}
                           </div>
                        </div>
        ...
        {activeSection === 'about' && (
          <div className="animate-fade-in">
            {/* About Us Content */}
            <section className="relative py-16 z-10 bg-slate-900/30">
              <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <section className="py-24 overflow-hidden relative border-t border-white/5">
               <div className="max-w-7xl mx-auto px-4 mb-12 text-center">
                  ...
                  <div className="flex justify-center gap-1">
                     {[1,2,3,4,5].map(s => <React.Fragment key={s}><StarIcon className="w-5 h-5 text-yellow-500" /></React.Fragment>)}
                  </div>
               </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-12">
            ...
            <div>
              ...
              <ul className="space-y-3 text-slate-400">
                <li><button onClick={() => navigateTo('catalogue')} className="hover:text-blue-400 transition-colors text-left">Product Sourcing</button></li>
                <li><button onClick={() => navigateTo('services')} className="hover:text-blue-400 transition-colors text-left">Custom Branding</button></li>
                <li><button onClick={() => navigateTo('services')} className="hover:text-blue-400 transition-colors text-left">Bulk Supply</button></li>
              </ul>
            </div>
            <div>
              <h4 className="text-white font-semibold mb-6">Company</h4>
              <ul className="space-y-3 text-slate-400">
                <li><button onClick={() => navigateTo('about')} className="hover:text-blue-400 transition-colors text-left">About Us</button></li>
                <li><button onClick={() => navigateTo('about')} className="hover:text-blue-400 transition-colors text-left">FAQ</button></li>
                <li><a href="https://kasilyfstyle.com" target="_blank" rel="noopener noreferrer" className="hover:text-blue-400 transition-colors">KasiLyf Style</a></li>
              </ul>
            </div>
            <div>
